...
////////////////////// GET /////////////////////
app.get('/api/v1/f1championships', login.WriteReadAccess, (req,res) => {
...
app.get('/api/v1/f1championships/:param', login.WriteReadAccess, (req,res) => {
  var regex = /^[0-9]{4}/;
...
app.get('/api/v1/f1championships/:country/:year', login.WriteReadAccess, (req,res) => {
